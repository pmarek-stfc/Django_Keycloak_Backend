"""
Django settings for Oauth2DjangoKeycloak project.
...
SECRET_KEY = 'z!ke9gh!g5ix#9i^)^)&_=e$-#6_ka@@*v9=74hr%af-$qvbs$'
...
ROOT_URLCONF = 'Oauth2DjangoKeycloak.urls'
...
WSGI_APPLICATION = 'Oauth2DjangoKeycloak.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'Oauth2DjangoKeycloak.authentication.KeycloakBackend',
]
LOGIN_URL = 'login'
# Keycloak settings
